...
function Header() {
  ...
  const toggel = useSelector(store=>store.movie.toggle);
          ...
          user && (
            <div className='flex item-center'>
                ...
                <div className='ml-4'>
                    ...
                    <button onClick={toggleHandler} className='bg-red-800 text-white px-4 py-2 ml-2'>{toggel ? "Home" : "Search Movie"}</button>
                </div>
            </div>
