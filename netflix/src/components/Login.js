  ...
  return (
    <div >
        ...
        <div className='absolute'>
            <img className='w-[100vw] h-[100vh]' src="https://wallpapers.com/images/hd/netflix-background-gs7hjuwvv2g0e9fj.jpg" alt="banner" />
        </div>
        <form onSubmit={getInputData} className='flex flex-col w-3/12 p-12 my-36 left-0 right-0 mx-auto item-center justify-center absolute bg-black opacity-90 '>
            ...
            <div className='flex flex-col'>
                ...
                <p className='text-white'> {isLogin ? "Already have an account?" : "New to Netflix?"} <span onClick={loginhandler} className='ml-1 font-medium cursor-pointer'>Login</span></p>
             </div>
        </form>
    </div>
  )
